...
static const ble_uuid_t * remote_svc_uuid =
    BLE_UUID128_DECLARE(0xf0, 0x00, 0xff, 0xc0, 0x04, 0x51, 0x40, 0x00,
...
static const ble_uuid_t * remote_chr_uuid =
    BLE_UUID128_DECLARE(0xf0, 0x00, 0xff, 0xc1, 0x04, 0x51, 0x40, 0x00,
                     	0xb0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00);
#endif
...
blecent_scan(void)
{
    ...
    ESP_LOGI(tag, "Initiating GAP discovery procedure");
...
blecent_gap_event(struct ble_gap_event *event, void *arg)
{
    ...
    case BLE_GAP_EVENT_DISC:
        ESP_LOGI(tag, "Received adv rfeport");
